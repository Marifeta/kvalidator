...
class TestRulesValueProperties : LibraryTest() {
    ...
    fun testBetweenValue() {
        ...
        assertTrue(Validator(testJsonBetween, rules, ru).validate(), "result should return true")
    }
    ...
    fun testBetweenValueFalse() {
        ...
        assertFalse(Validator(testJson, rules, ru).validate(), "result should return false")
    }
